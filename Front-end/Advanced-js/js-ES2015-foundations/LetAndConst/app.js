// VAR variables are scoped to a function, but nothing else
...
//no access to var song here

var teenager = "Melina";
console.log(teenager);
//this is accesible anywhere BELOW it

//let and const don't create variables that persist for the whole program
//let and const variables are generally available where they are needed and that's it
//let variables annot be assigned to be two different things in the same scope, which avoids confusion
//const variables cannot be reassigned or redeclared, further preventing confusion, but it's useful so we use let for thatkk
